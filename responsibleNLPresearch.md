...
The checklist templates are available as either a [LaTeX template](/static/responsibleNLPresearch.tex) or as [a fillable PDF](/static/responsibleNLPresearch.pdf).
