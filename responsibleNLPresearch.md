...
The checklist templates are available as either a [LaTeX template](/static/responsibleNLPresearch.tex) or as [aa fillable PDF](/static/responsibleNLPresearch.pdf).
